...
public class PlayerAnimation : MonoBehaviour
{
    ...
    private static readonly int IsVacuumGhost = Animator.StringToHash("IsVacuumGhost");
    ...
    public void SetVacuumGhost(bool isVacuumingGhost)
    {
        animator.SetBool(IsVacuumGhost, isVacuumingGhost);
    }
}